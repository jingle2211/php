...
class Home extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('Finance/Home_model');
        $this->load->model('Finance/user');
    }
    ...
    public function add_client() {
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            if (isset($_POST['add'])) {
                ...
                redirect('Finance/Home/add_client');
            }

            $this->load->model("Home_model");
            $data["fetch_cus"] = $this->Home_model->fetch_cus();
            $this->load->view('finance/header', $data);
            $this->load->view('finance/add_client');
            $this->load->view('finance/footer');
        } else {
            redirect('Finance/Users');
        }
    ...
    public function today_report() {
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            $this->load->view('finance/header', $data);
            $this->load->view('finance/today_report', $data);
            $this->load->view('finance/footer');
        } else {
            redirect('Finance/Users');
        }
    ...
    public function view_clients() {
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            if (isset($del_id)) {
                ...
                redirect('Finance/Home/view_clients');
            }
            $this->load->view('finance/header', $data);
            $this->load->view('finance/view_clients', $data);
            $this->load->view('finance/footer');
        } else {
            redirect('Finance/Users');
        }
    ...
    public function add_credit() {
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            $data["fetch_cus"] = $this->Home_model->fetch_cus();
            $this->load->view('finance/header', $data);
            $this->load->view('finance/view_clients');
            $this->load->view('finance/footer');
        } else {
            redirect('Finance/Users');
        }
