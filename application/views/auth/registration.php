                  ...
                  <div class="p-5">
                    ...
                    <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                      ...
                      <div class="form-group row">
					   ...
					   <input type="text" class="form-control form-control-user" id="branch" name="branch" placeholder="Branch"
                        value="<?= set_value('text'); ?>">
                        <?= form_error('Branch', '<small class="text-danger pl-3">', '</small>'); ?>
					  </div>
					   <div class="col-sm-6 mb-3 mb-sm-0">
					   <input type="text" class="form-control form-control-user" id="user" name="user" placeholder="User Type"
                        value="<?= set_value('text'); ?>">
