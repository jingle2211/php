            ...
            <div class="col-md-6 stretch-card grid-margin rounded-0 shadow-md">
                <div class="card bg-gradient-info card-img-holder text-white">
                    <div class="card-body">
                        <img src="<?php echo base_url() ?>assets/images/dashboard/circle.svg" class="card-img-absolute"
                            alt="circle-image" />
                        <h4 class="font-weight-normal mb-3"> Cradited Amount
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 align-middle text-center">
                                            ...
                                            <a class="btn btn-danger bg-gradient-danger btn-xs rounded-0 p-2"
                                                href="<?php echo base_url() ?>Finance/Home/add_debit?del=<?php echo $row->deb_id ?>"
                                                aria-label="Delete"
                                        ...
                                        <div class="w3-modal-content">
                                            ...
                                            <div class="w3-container">
                                                <form class="forms-sample" method="post"
                                                    action="<?php echo base_url() ?>/Finance/Home/add_debit?id=<?php echo $row->deb_id ?>&del_id=<?php echo $row->id ?> ">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 align-middle text-center">
                                            ...
                                            <a class="btn btn-danger bg-gradient-danger btn-xs p-2 rounded-0"
                                                href="<?php echo base_url() ?>Finance/Home/add_credit?del=<?php echo $row->cre_id ?>"
                                        ...
                                        <div id="id07<?php echo $j; ?>" class="w3-modal">
                                            <div class="w3-modal-content">
                                                ...
                                                <div class="w3-container">
                                                    <form class="forms-sample" method="post"
                                                        action="<?php echo base_url() ?>/Finance/Home/add_credit?id=<?php echo $row->cre_id ?>&del_id=<?php echo $row->id ?> ">
                                                        <div class="form-group">
                                                            <label for="exampleFormControlSelect3">Name</label>
                                                            <input name="" readonly="" type="text"
                                                                class="form-control form-control-sm"
