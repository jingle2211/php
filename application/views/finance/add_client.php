           ...
           <div class="col-12 grid-margin stretch-card">
              <div class="card rounded-0">
                <div class="card-header bg-gradient-info text-white rounded-0">
                  <h4 class="card-title text-white mb-0">User Details</h4>
                </div>
                <div class="card-body">
...
?>   
                  ...
                  <form class="forms-sample" method="post" action="<?php echo base_url() ?>/Finance/Home/add_client">
                    ...
                    <div class="form-group text-center">
                          ...
                          <a class="btn btn-light border rounded-0" href="<?= base_url('Finance/Home/view_clients') ?>">Cancel</a>
                    </div>
                  </form>
                </div>
              </div>
