...
.tab {
    ...
    <h5 class="card-title text-white mb-0">User Profile</h5>
    </div>
    <div class="card-body  py-2">
    <form class="form-inline" method="post" action="<?php echo base_url() ?>Finance/Home/report">
    <?php     
     $name="";
    ...
    <th class="p-2 text-center"> Exp Category </th>
