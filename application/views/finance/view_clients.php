           ...
           ?> 
            <tr>
                ...
                <td class="px-3 py-2 align-middle text-center">
                    ...
                    <a class="btn btn-gradient-info rounded-0 btn-sm" href="<?php echo  base_url() ?>Finance/Home/debit_credit_p?id=<?php echo $row->id ?>" aria-label="Skip to main navigation">
                      <i class="fa fa-bars" aria-hidden="true"></i>
                    </a>
                    <a class="btn btn-gradient-danger rounded-0 btn-sm" href="<?php echo  base_url() ?>Finance/Home/view_clients?del=<?php echo $row->id ?>" onclick="return confirm('Are you sure you want to delete this Recipient?');" aria-label="Delete">
