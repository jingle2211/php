                ...
                <div class="single-main-content">
                    <article class="post-content">
                        ...
                        <?php if (!empty($data['title'])):
                             echo $data['title']; endif; ?>
                            </h2>
                        </div><!-- /.entry-header -->
                        <span class="post-thumb">
                            <?php if (!empty($data['title'])): ?>
                                <img src="<?= base_url(); ?>upload/blogs/<?php echo $data['image']; ?>" alt="blog" />
                            <?php endif; ?>
                            </sapn><!-- /.post-thumb -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="comments-title">
                                        <?= count($comm) + count($replay); ?> Comments
                                    </h3><!--/.comments-title-->
                                </div><!--/.col-md-12-->
                            </div><!--/.row-->
                            <div class="row">
                                            ...
                                            <li class="comment">
                                                <div class="comment-body">
                                                    <div class="comment-meta">
                                                        ...
                                                        <div class="comment-metadata"><b class="author">
                                                                <?= $value['name']; ?>
                                                            </b>
                                                            <span class="date">
                                                                <?php echo date('h:i a, d-M-Y', strtotime($value['date'])); ?>
                                                            </span>
                                                    ...
                                                    <div class="comment-details">
                                                        ...
                                                        <div class="reply">
                                                            <button class="comment-reply-link" id="replybtn"
                                                                onclick="formview(<?= $value['c_id']; ?>)">Reply </button>
                                                            <div id="replyform<?= $value['c_id']; ?>" class="rf"
                                                                style="    padding: 20px;">
                                                                <form method="post" id="replayc" name="commentForm">
                                                                    <div class="row">
                                                                        <div class="col-md-6 col-sm-6 padding-right">
                                                                            <p>
                                                                                ...
                                                                                <input type="hidden"
                                                                                    ...
                                                                                    value="<?= $value['c_id']; ?>">
                                                                                <input type="hidden"
                                                                                    id="postid<?= $value['c_id']; ?>"
                                                                                    value="<?php if (!empty($data['id'])):
                                                                                        echo $data['id']; endif; ?>">
                                                                            </p>
                                                                        </div><!--/.col-md-6-->
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <p>
                                                                                <textarea name="comment"
                                                                                    id="comment<?= $value['c_id']; ?>"
                                                                                    aria-required="true" rows="3" cols="10"
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <p class="form-submit ">
                                                                                <button type="button" id="csubmit"
                                                                                    onclick="replasub(<?= $value['c_id']; ?>);"
                                                                                    class="comment-reply-link">Post a
                                                                                    comments</button>
                                                                            </p>
                                                                        </div><!--/.col-md-12-->
                                                                    </div><!--/.row-->
                                                                    ...
                                                                    <div class="comment-body">
                                                                        <div class="comment-meta">
                                                                            <div class="comment-metadata"><b class="author">
                                                                                ...
                                                                                <span class="date">
                                                                                    <?php echo date('h:i a, d-M-Y', strtotime($re['date'])); ?>
                                                                                </span>
                                                                            </div><!--/.comment-metadata-->
                                                                        </div><!--/.comment-meta-->
                                                                        <div class="comment-details">
                                                                            ...
                                                                            <div class="reply">
                                                                                <button class="comment-reply-link" id="replybtn"
                                                                                    onclick="formview(<?= $re['c_id']; ?>)">Reply </button>
                                                                                <div id="replyform<?= $re['c_id']; ?>" class="rf"
                                                                                    style="    padding: 20px;">
                                                                                    <form method="post" id="replayc" name="commentForm">
                                                                                        <div class="row">
                                                                                            <div class="col-md-6 col-sm-6 padding-right">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p>
                                                <input type="text" name="email" id="email" aria-required="true"
                                                    placeholder="Email*" class="form-controllar">
                                            </p>
                                        </div><!--/.col-md-6-->
                                        <div class="col-md-12">
                                            <p>
                                                <textarea name="comment" id="comment" aria-required="true" rows="1"
                                                    cols="10" placeholder="Write a Comment...."
                                                    class="form-controllar"></textarea>
                                            </p>
                                        </div><!--/.col-md-12-->
                                        <div class="col-md-12">
                                            <p class="form-submit ">
                                                <button type="button" id="submit" class="button">Post a
                                                    comments</button>
                                            </p>
                                        </div><!--/.col-md-12-->
                                    </div><!--/.row-->
                                    ...
                                    <div class="post-content clearfix">
                                        <div class="image-content">
                                            <?php if (!empty($value['image'])): ?>
                                                <a href="<?= base_url() . 'blogs/' . $value['slug']; ?>"> <img
                                                        src="<?= base_url(); ?>upload/blogs/<?php echo $value['image']; ?>"
                                                        alt="blog" /> </a>
                                            <?php endif; ?>
                                        </div><!-- /.image-content -->
                                        <div class="post-info">
                                            <h5 class="widget-post-title"><a
                                                    href="<?= base_url() . 'blogs/' . $value['slug']; ?>"><?= substr($value['title'], 0, 40) ?></a></h5>
                                            <span class="post-date">
                                                <?= date("d-M-Y", strtotime($value['modifydate'])) ?>
                                            </span>
                                        </div><!-- /.post-info -->
                                    </div><!-- /.post-content -->
...
<script type='text/javascript'
    src='//platform-api.sharethis.com/js/sharethis.js#property=5c594eeefec5f10011f26201&product=social-ab'
    async='async'></script>
...
<script type="text/javascript">
    function replasub(id) {
        ...
        if (valid == 1) {
            $.post(base + 'Blogs/addreplaycomment',
                {
                    n: name,
                    e: email,
                    c: comment,
