...
if (isset($result_display)) {
    ...
    if ($result_display == 'No record found !') {
        ...
        foreach ($result_display as $value) {
            ...
            echo '<div class="visa-main"><strong class="visa-text">Name:</strong> ' . $value->name . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Location:</strong> ' . $value->location . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Time:</strong> ' . $value->time . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Area:</strong> ' . $value->area . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Population:</strong> ' . $value->population . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Currency:</strong> ' . $value->currency . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Capital:</strong> ' . $value->capital . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Climate:</strong> ' . $value->climate . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Lanagugae:</strong> ' . $value->language . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Airlines:</strong> ' . $value->airline . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Airport:</strong> ' . $value->airport . '</div>';
            echo '<div class="visa-main"><strong class="visa-text">Holidays:</strong> ' . $value->holiday . '</div>';
