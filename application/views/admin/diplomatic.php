...
<input type="text" name="Email" class="form-control" id="Email">
                    ...
                    <div class="row">
                    <div class="col-lg-2 col-md-2">
                    <label>Office Timings:<span>*</span></label>
                    </div>
                    <div class="col-lg-4 col-md-4 col-xs-12">
                    <input type="text" name="Office" class="form-control" id="Office" required >
                    </div>
                    <div class="col-lg-2 col-md-2">
                    <label>Visa Timings:<span>*</span></label>
                    </div>
                    <div class="col-lg-4 col-md-4 col-xs-12">
                    <input type="text" name="Visa" class="form-control" id="Visa" required >
                    </div>
                    </div>
                  
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                    <label>Collection Timings:</label>
                    </div>                          
                    <div class="col-lg-4 col-md-4 col-xs-12">
