        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Application</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $application; ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-file-alt fa-2x text-gray-500"></i>
                        </div>
                ...
                <small><a class="ml-3" href="<?= base_url('admin/application_report'); ?>">View &rarr;</a></small>
            </div>
        </div>
