                ...
                <div class="col-lg-12 col-md-12">                    
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="usersettings" aria-expanded="false">
                            <div class="card">
                                <div class="header">
                                    <h2><strong>Add New</strong>  Testimonial</h2>
                                </div>
                                <div class="body">
                                    <?= form_open_multipart('Admin/add_testimonial'); ?>
                                    <label for="email_address">Enter Name</label>
                                    <div class="form-group">
                                        <input type="text" class="form-control title" id="title" placeholder="Title" name="name" required>
                                    </div> 
                                    <label for="email_address">Positions</label>
                                      <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Positions" name="position" required>
                                    </div>
                                      <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" placeholder="Oder No." name="orderno" required>
                                    </div>
