...
<div class="pull-right" style="padding:10px;/* padding-top: 289px; */position: relative;right: 0%;bottom: -86px;">
...
<img border="0" alt="whatsapp" src="images/green2-round.png" width="70" height="70"></a>
</div>
<div class="container">
   <!-- footer-top-block -->
       ...
       <div class="row">
           ...
           <div class="col-md-4 col-sm-6">
               <div class="widget widget_hot_contact">
                   ...
                   <ul>
                       <li><a href="#"><i class="fa fa-envelope"></i>sales@ivsvisa.com</a></li>
                       <li><a href="#"><i class="fa fa-phone"></i>+91-11-46578585, 3887, 3888, 3889</a></li>
                       <li><a href="#"><i class="fa fa-map-marker"></i>84 - C Ground Floor, Bharat Nagar, New Friends Colony,New Delhi - 110025</a></li>
                   </ul> 
               </div><!-- /.widget -->
       ...
       <div class="row">
            <div class="col-md-9">
               <div class="bottom-content-left">
                   <p class="copyright">Copyright &copy; 2023 IVS Visa  -  All Right Reserved Powered By <a href="#" target="_blank">Jingle infosolutions pvt.Ltd</a></p>
