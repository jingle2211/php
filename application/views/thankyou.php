...
<div class="page-header nevy-bg">
        ...
        <div class="row">
        <div class="col-md-12">                
        <h2 class="page-title">ONLINE VISA TRACKING</h2>                
        </div><!-- /.col-md-12 -->
        </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div>
    ...
    <div class="container">
        ...
        It is flawless, seamless visa process for our valued customers </p>
            ...
            <div class="row">
                ...
                <img src="images/002.png" alt="visa Facilitation" />
                </div>
                </div><!-- /.col-md-5 -->
                ...
                <div class="service-block wc">
                    ...
                    <li class="discription">Accuracy and clarity in application</li>                   
                    <li class="discription">Sales innovation and USP- This product has been presented to lot of customers across India and the excitement shown by them is very encouraging.</li>
                    <li class="discription">The VISA Tracking Facility is offered to all our clients through our web site.</li>
                    <li class="discription">Complete process movement of passport is online starting from handing over the documents till receiving back with visa, in-turn reducing cost of telephones since all updates generate automatic emails, i.e. No need to call and check status from the back office.</li>
                    <li class="discription">All details are hosted on Server for a quick reference incase of any future reference</li>
                    <li class="discription">The section is password protected for security reasons</li>
                    <li class="discription">Reduced client or staff irritation</li>
