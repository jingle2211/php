    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('<div></div>').addClass('btn-group mr-2 sw-btn-group-extra hiddenbtn').attr('role', 'group');
        ...
        _setButtons: function (idx) {
            ...
            if (!this.options.cycleSteps) {
                if (0 >= idx) {
                    $('.sw-btn-prev', this.main).addClass("hiddenbtn");
                } else {
                    $('.sw-btn-prev', this.main).removeClass("hiddenbtn");
                }
                if (this.steps.length - 1 <= idx) {
                    $('.sw-btn-next', this.main).addClass("hiddenbtn");
                     $('.sw-btn-group-extra', this.main).removeClass("hiddenbtn");
                } else {
                    $('.sw-btn-next', this.main).removeClass("hiddenbtn");
                     $('.sw-btn-group-extra', this.main).addClass("hiddenbtn");
                }
            }
            return true;
        },
