if (function(e, t) {
        ...
        function d() {
            ne.removeEventListener("DOMContentLoaded", d), e.removeEventListener("load", d), fe.ready()
        }
        ...
        function g(e) {
            var t, n = e.ownerDocument,
                i = e.nodeName,
                o = ze[i];
            return o || (t = n.body.appendChild(n.createElement(i)), o = fe.css(t, "display"), t.parentNode.removeChild(t), "none" === o && (o = "block"), ze[i] = o, o)
        }

        function v(e, t) {
            for (var n, i, o = [], r = 0, s = e.length; r < s; r++) i = e[r], i.style && (n = i.style.display, t ? ("none" === n && (o[r] = $e.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && Fe(i) && (o[r] = g(i))) : "none" !== n && (o[r] = "none", $e.set(i, "display", n)));
        ...
        function w(e, t, n, i, o) {
            for (var r, s, a, l, u, c, d = t.createDocumentFragment(), h = [], p = 0, f = e.length; p < f; p++)
                if ((r = e[p]) || 0 === r)
                    if ("object" === fe.type(r)) fe.merge(h, r.nodeType ? [r] : r);
                    else if (Ue.test(r)) {
                for (s = s || d.appendChild(t.createElement("div")), a = (Re.exec(r) || ["", ""])[1].toLowerCase(), l = qe[a] || qe._default, s.innerHTML = l[1] + fe.htmlPrefilter(r) + l[2], c = l[0]; c--;) s = s.lastChild;
                fe.merge(h, s.childNodes), s = d.firstChild, s.textContent = ""
            } else h.push(t.createTextNode(r));
            for (d.textContent = "", p = 0; r = h[p++];)
                if (i && fe.inArray(r, i) > -1) o && o.push(r);
                else if (u = fe.contains(r.ownerDocument, r), s = y(d.appendChild(r), "script"), u && b(s), n)
                for (c = 0; r = s[c++];) Be.test(r.type || "") && n.push(r);
            return d
        }
        ...
        function O(e, t) {
            ...
            if (1 === t.nodeType) {
                if ($e.hasData(e) && (r = $e.access(e), s = $e.set(t, r), u = r.events)) {
                    ...
                    for (o in u)
                        for (n = 0, i = u[o].length; n < i; n++) fe.event.add(t, o, u[o][n])
                }
                Ae.hasData(e) && (a = Ae.access(e), l = fe.extend({}, a), Ae.set(t, l))
            }
        }
        ...
        function M(e, t, i, o) {
            ...
            var r, s, a, l, u, c, d = 0,
                ...
                f = t[0],
                m = fe.isFunction(f);
            if (m || h > 1 && "string" == typeof f && !pe.checkClone && Xe.test(f)) return e.each(function(n) {
                var r = e.eq(n);
                m && (t[0] = f.call(this, n, r.html())), M(r, t, i, o)
            });
            if (h && (r = w(t, e[0].ownerDocument, !1, e, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
                for (a = fe.map(y(r, "script"), S), l = a.length; d < h; d++) u = r, d !== p && (u = fe.clone(u, !0, !0), l && fe.merge(a, y(u, "script"))), i.call(e[d], u, d);
                if (l)
                    for (c = a[a.length - 1].ownerDocument, fe.map(a, D), d = 0; d < l; d++) u = a[d], Be.test(u.type || "") && !$e.access(u, "globalEval") && fe.contains(c, u) && (u.src ? fe._evalUrl && fe._evalUrl(u.src) : n(u.textContent.replace(Ke, ""), c))
            }
            return e
        }

        function $(e, t, n) {
            for (var i, o = t ? fe.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || fe.cleanData(y(i)), i.parentNode && (n && fe.contains(i.ownerDocument, i) && b(y(i, "script")), i.parentNode.removeChild(i));
            return e
        }

        function A(e, t, n) {
            var i, o, r, s, a = e.style;
            return n = n || nt(e), n && (s = n.getPropertyValue(t) || n[t], "" !== s || fe.contains(e.ownerDocument, e) || (s = fe.style(e, t)), !pe.pixelMarginRight() && tt.test(s) && et.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function W(e, t, n, i, o) {
            var r, s = 0;
            for (r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; r < 4; r += 2) "margin" === n && (s += fe.css(e, n + We[r], !0, o)), i ? ("content" === n && (s -= fe.css(e, "padding" + We[r], !0, o)), "margin" !== n && (s -= fe.css(e, "border" + We[r] + "Width", !0, o))) : (s += fe.css(e, "padding" + We[r], !0, o), "padding" !== n && (s += fe.css(e, "border" + We[r] + "Width", !0, o)));
            return s
        }
        ...
        function F(e, t, n) {
            ...
            return tt.test(r) ? r : (i = s && (pe.boxSizingReliable() || r === e.style[t]), "auto" === r && (r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (r = parseFloat(r) || 0) + W(e, t, n || (s ? "border" : "content"), i, o) + "px")
        }
        ...
        function z() {
            ct && (!1 === ne.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(z) : e.setTimeout(z, fe.fx.interval), fe.fx.tick())
        }
        ...
        function q(e, t, n) {
            ...
            if ((l = !fe.isEmptyObject(t)) || !fe.isEmptyObject(p)) {
                d && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = g && g.display, null == u && (u = $e.get(e, "display")), c = fe.css(e, "display"), "none" === c && (u ? c = u : (v([e], !0), u = e.style.display || u, c = fe.css(e, "display"), v([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === fe.css(e, "float") && (l || (h.done(function() {
                    f.display = u
                }), null == u && (c = f.display, u = "none" === c ? "" : c)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", h.always(function() {
                    f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                })), l = !1;
                for (i in p) l || (g ? "hidden" in g && (m = g.hidden) : g = $e.access(e, "fxshow", {
                    display: u
                }), r && (g.hidden = !m), m && v([e], !0), h.done(function() {
                    m || v([e]), $e.remove(e, "fxshow");
        ...
        function U(e, t) {
            var n, i, o, r, s;
            for (n in e)
                if (i = fe.camelCase(n), o = t[i], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = fe.cssHooks[i]) && "expand" in s) {
        ...
        function Y(e, t, n) {
            var i, o, r = 0,
                ...
                l = function() {
                    if (o) return !1;
                    for (var t = ut || L(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(r);
            ...
            return fe.map(c, B, u), fe.isFunction(u.opts.start) && u.opts.start.call(e, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), fe.fx.timer(fe.extend(l, {
                elem: e,
                anim: u,
                queue: u.opts.queue
            })), u
        ...
        function V(e, t, n, i) {
            ...
            if (Array.isArray(t)) fe.each(t, function(t, o) {
                n || xt.test(e) ? i(e, o) : V(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, i)
            });
        ...
        fe.fn = fe.prototype = {
            ...
            for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || fe.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
                if (null != (e = arguments[a]))
                    for (t in e) n = s[t], i = e[t], s !== i && (u && i && (fe.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && fe.isPlainObject(n) ? n : {}, s[t] = fe.extend(u, r, i)) : void 0 !== i && (s[t] = i));
            return s
        }, fe.extend({
            ...
            isPlainObject: function(e) {
                var t, n;
                return !(!e || "[object Object]" !== ue.call(e)) && (!(t = ie(e)) || "function" == typeof(n = ce.call(t, "constructor") && t.constructor) && de.call(n) === he)
            },
            ...
            proxy: function(e, t) {
                var n, i, o;
                if ("string" == typeof t && (n = e[t], t = e, e = n), fe.isFunction(e)) return i = oe.call(arguments, 2), o = function() {
        ...
        var ge = function(e) {
            function t(e, t, n, i) {
                var o, r, s, a, l, c, h, p = t && t.ownerDocument,
                    f = t ? t.nodeType : 9;
                if (n = n || [], "string" != typeof e || !e || 1 !== f && 9 !== f && 11 !== f) return n;
                if (!i && ((t ? t.ownerDocument || t : H) !== $ && M(t), t = t || $, j)) {
                    if (11 !== f && (l = me.exec(e)))
                        if (o = l[1]) {
                            if (9 === f) {
                    ...
                    if (w.qsa && !q[e + " "] && (!I || !I.test(e))) {
                        if (1 !== f) p = t, h = e;
                            ...
                            for ((a = t.getAttribute("id")) ? a = a.replace(be, we) : t.setAttribute("id", a = F), c = k(e), r = c.length; r--;) c[r] = "#" + a + " " + d(c[r]);
                            h = c.join(","), p = ge.test(e) && u(t.parentNode) || t
                        }
                        if (h) try {
                        ...
                        for (; t = t[i];)
                            if (1 === t.nodeType || s)
                                if (d = t[F] || (t[F] = {}), c = d[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t;
                                    ...
                                    if ((u = c[r]) && u[0] === z && u[1] === a) return h[2] = u[2];
                ...
                return o && !o[F] && (o = g(o)), r && !r[F] && (r = g(r, s)), i(function(i, s, a, l) {
                    ...
                    if (i) {
                        if (r || e) {
                            ...
                            for (c = b.length; c--;)(d = b[c]) && (u = r ? Z(i, d) : h[c]) > -1 && (i[u] = !(s[u] = d))
                        }
                    } else b = m(b === s ? b.splice(g, b.length) : b), r ? r(null, s, b, l) : G.apply(s, b)
                })
            }
                ...
                for (var t, n, i, o = e.length, r = x.relative[e[0].type], s = r || x.relative[" "], a = r ? 1 : 0, l = h(function(e) {
                    ...
                    if (n = x.relative[e[a].type]) c = [h(p(c), n)];
                        ...
                        if (n = x.filter[e[a].type].apply(null, e[a].matches), n[F]) {
                            ...
                            return g(a > 1 && p(c), a > 1 && d(e.slice(0, a - 1).concat({
                                value: " " === e[a - 2].type ? "*" : ""
                ...
                var o = n.length > 0,
                    ...
                    s = function(i, s, a, l, u) {
                        var c, d, h, p = 0,
                            ...
                            T = b.length;
                        for (u && (D = s === $ || s || u); f !== T && null != (c = b[f]); f++) {
                            if (r && c) {
                                for (d = 0, s || c.ownerDocument === $ || (M(c), a = !j); h = e[d++];)
                                    if (h(c, s || $, a)) {
                                        l.push(c);
                                        break
                                    }
            ...
            var b, w, x, T, C, k, _, S, D, O, E, M, $, A, j, I, N, P, W, F = "sizzle" + 1 * new Date,
                H = e.document,
                z = 0,
                L = 0,
                R = n(),
            ...
            try {
                G.apply(J = X.call(H.childNodes), H.childNodes), J[H.childNodes.length].nodeType
            } catch (e) {
                G = {
            ...
            w = t.support = {}, C = t.isXML = function(e) {
                ...
                return i !== $ && 9 === i.nodeType && i.documentElement ? ($ = i, A = $.documentElement, j = !C($), H !== $ && (n = $.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), w.attributes = o(function(e) {
                    return e.className = "i", !e.getAttribute("className")
                }), w.getElementsByTagName = o(function(e) {
                    return e.appendChild($.createComment("")), !e.getElementsByTagName("*").length
                }), w.getElementsByClassName = fe.test($.getElementsByClassName), w.getById = o(function(e) {
                    return A.appendChild(e).id = F, !$.getElementsByName || !$.getElementsByName(F).length
                ...
                }, N = [], I = [], (w.qsa = fe.test($.querySelectorAll)) && (o(function(e) {
                ...
                })), (w.matchesSelector = fe.test(P = A.matches || A.webkitMatchesSelector || A.mozMatchesSelector || A.oMatchesSelector || A.msMatchesSelector)) && o(function(e) {
                    w.disconnectedMatch = P.call(e, "*"), P.call(e, "[s!='']:x"), N.push("!=", ie)
                }), I = I.length && new RegExp(I.join("|")), N = N.length && new RegExp(N.join("|")), t = fe.test(A.compareDocumentPosition), W = t || fe.test(A.contains) ? function(e, t) {
                    ...
                    return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === $ || e.ownerDocument === H && W(H, e) ? -1 : t === $ || t.ownerDocument === H && W(H, t) ? 1 : O ? Z(O, e) - Z(O, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return E = !0, 0;
                    var n, i = 0,
                        o = e.parentNode,
                        ...
                        a = [e],
                        l = [t];
                    if (!o || !r) return e === $ ? -1 : t === $ ? 1 : o ? -1 : r ? 1 : O ? Z(O, e) - Z(O, t) : 0;
                    if (o === r) return s(e, t);
                ...
                if ((e.ownerDocument || e) !== $ && M(e), n = n.replace(le, "='$1']"), w.matchesSelector && j && !q[n + " "] && (!N || !N.test(n)) && (!I || !I.test(n))) try {
                    var i = P.call(e, n);
                    if (i || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
                } catch (e) {}
                return t(n, $, null, [e]).length > 0
            }, t.contains = function(e, t) {
                return (e.ownerDocument || e) !== $ && M(e), W(e, t)
            }, t.attr = function(e, t) {
                (e.ownerDocument || e) !== $ && M(e);
                var n = x.attrHandle[t.toLowerCase()],
                    i = n && Y.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !j) : void 0;
                ...
                var t, n = [],
                    i = 0,
                    o = 0;
                if (E = !w.detectDuplicates, O = !w.sortStable && e.slice(0), e.sort(U), E) {
                        ...
                        return 1 === i && 0 === o ? function(e) {
                            ...
                            if (g) {
                                ...
                                if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (h = g, d = h[F] || (h[F] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[e] || [], p = u[0] === z && u[1], b = p && u[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (b = p = 0) || f.pop();)
                                        if (1 === h.nodeType && ++b && h === t) {
                                            c[e] = [z, p, b];
                                            break
                                        }
                                } else if (y && (h = t, d = h[F] || (h[F] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[e] || [], p = u[0] === z && u[1], b = p), !1 === b)
                                    for (;
                                        (h = ++p && h && h[m] || (b = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && (d = h[F] || (h[F] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), c[e] = [z, b]), h !== t)););
            ...
            return c.prototype = x.filters = x.pseudos, x.setFilters = new c, k = t.tokenize = function(e, n) {
                ...
                if (n = n || [], 1 === h.length) {
                    if (r = h[0] = h[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && 9 === t.nodeType && j && x.relative[r[1].type]) {
                    ...
                    for (o = de.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !x.relative[a = s.type]);)
                        if ((l = x.find[a]) && (i = l(s.matches[0].replace(ve, ye), ge.test(r[0].type) && u(t.parentNode) || t))) {
                            if (r.splice(o, 1), !(e = i.length && d(r))) return G.apply(n, i), n;
                            break
                        }
                }
                return (c || _(e, h))(i, t, !j, n, !t || ge.test(e) && u(t.parentNode) || t), n
            }, w.sortStable = F.split("").sort(U).join("") === F, w.detectDuplicates = !!E, M(), w.sortDetached = o(function(e) {
        ...
        (fe.fn.init = function(e, t, n) {
            ...
            if (n = n || Te, "string" == typeof e) {
                ...
                if (i[1]) {
                    if (t = t instanceof fe ? t[0] : t, fe.merge(this, fe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)), we.test(i[1]) && fe.isPlainObject(t))
        ...
        fe.fn.extend({
            ...
            fe.fn[e] = function(n, i) {
                ...
                return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = fe.filter(i, o)), this.length > 1 && (_e[e] || fe.uniqueSort(o), ke.test(e) && o.reverse()), this.pushStack(o)
            }
        });
        var Se = /[^\x20\t\r\n\f]+/g;
        fe.Callbacks = function(e) {
                    ...
                    add: function() {
                        return r && (n && !t && (l = r.length - 1, s.push(n)), function t(n) {
                            fe.each(n, function(n, i) {
                                fe.isFunction(i) ? e.unique && c.has(i) || r.push(i) : i && i.length && "string" !== fe.type(i) && t(i)
                            })
                    ...
                    o = {
                        ...
                        then: function(t, i, o) {
                                    ...
                                    var a = this,
                                        ...
                                        d = function() {
                                            ...
                                            if (!(t < s)) {
                                                ...
                                                d = e && ("object" == typeof e || "function" == typeof e) && e.then, fe.isFunction(d) ? o ? d.call(e, r(s, n, l, o), r(s, n, u, o)) : (s++, d.call(e, r(s, n, l, o), r(s, n, u, o), r(s, n, l, n.notifyWith))) : (i !== l && (a = void 0, c = [e]), (o || n.resolveWith)(a, c))
                                            }
                                        },
                                        h = o ? d : function() {
                                            try {
                                                ...
                                                fe.Deferred.exceptionHook && fe.Deferred.exceptionHook(e, h.stackTrace), t + 1 >= s && (i !== u && (a = void 0, c = [e]), n.rejectWith(a, c))
                                            }
                                        };
                            ...
                            return fe.Deferred(function(e) {
                                n[0][3].add(r(0, e, fe.isFunction(o) ? o : l, e.notifyWith)), n[1][3].add(r(0, e, fe.isFunction(t) ? t : l)), n[2][3].add(r(0, e, fe.isFunction(i) ? i : u))
                            }).promise()
                        },
                        promise: function(e) {
            ...
            when: function(e) {
                ...
                if (t <= 1 && (c(e, r.done(s(n)).resolve, r.reject, !t), "pending" === r.state() || fe.isFunction(o[n] && o[n].then))) return r.then();
        ...
        fe.fn.ready = function(e) {
            ...
            readyWait: 1,
            ready: function(e) {
                (!0 === e ? --fe.readyWait : fe.isReady) || (fe.isReady = !0, !0 !== e && --fe.readyWait > 0 || Oe.resolveWith(ne, [fe]))
            }
        }), fe.ready.then = Oe.then, "complete" === ne.readyState || "loading" !== ne.readyState && !ne.documentElement.doScroll ? e.setTimeout(fe.ready) : (ne.addEventListener("DOMContentLoaded", d), e.addEventListener("load", d));
        ...
        h.uid = 1, h.prototype = {
            ...
            set: function(e, t, n) {
                ...
                if ("string" == typeof t) o[fe.camelCase(t)] = n;
                    ...
                    for (i in t) o[fe.camelCase(i)] = t[i];
                return o
            },
            get: function(e, t) {
            ...
            remove: function(e, t) {
                ...
                if (void 0 !== i) {
                    if (void 0 !== t) {
                        Array.isArray(t) ? t = t.map(fe.camelCase) : (t = fe.camelCase(t), t = t in i ? [t] : t.match(Se) || []), n = t.length;
                        for (; n--;) delete i[t[n]]
        ...
        fe.extend({
            ...
            data: function(e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (o = Ae.get(r), 1 === r.nodeType && !$e.get(r, "hasDataAttrs"))) {
                        for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = fe.camelCase(i.slice(5)), f(r, i, o[i])));
            ...
            queue: function(e, t, n) {
                var i;
                if (e) return t = (t || "fx") + "queue", i = $e.get(e, t), n && (!i || Array.isArray(n) ? i = $e.access(e, t, fe.makeArray(n)) : i.push(n)), i || []
            },
        ...
        fe.event = {
            ...
            add: function(e, t, n, i, o) {
                var r, s, a, l, u, c, d, h, p, f, m, g = $e.get(e);
                if (g)
                    for (n.handler && (r = n, n = r.handler, o = r.selector), o && fe.find.matchesSelector(Ye, o), n.guid || (n.guid = fe.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(t) {
                            return void 0 !== fe && fe.event.triggered !== t.type ? fe.event.dispatch.apply(e, arguments) : void 0
                        }), t = (t || "").match(Se) || [""], u = t.length; u--;) a = Ve.exec(t[u]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p && (d = fe.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = fe.event.special[p] || {}, c = fe.extend({
                        type: p,
                        origType: m,
                        data: i,
                        handler: n,
                        ...
                        namespace: f.join(".")
                    }, r), (h = l[p]) || (h = l[p] = [], h.delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, f, s) || e.addEventListener && e.addEventListener(p, s)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, c) : h.push(c), fe.event.global[p] = !0)
            },
            remove: function(e, t, n, i, o) {
                var r, s, a, l, u, c, d, h, p, f, m, g = $e.hasData(e) && $e.get(e);
                if (g && (l = g.events)) {
                    for (t = (t || "").match(Se) || [""], u = t.length; u--;)
                        if (a = Ve.exec(t[u]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                            for (d = fe.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, h = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = h.length; r--;) c = h[r], !o && m !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (h.splice(r, 1), c.selector && h.delegateCount--, d.remove && d.remove.call(e, c));
                            s && !h.length && (d.teardown && !1 !== d.teardown.call(e, f, g.handle) || fe.removeEvent(e, p, g.handle), delete l[p])
                        } else
            ...
            dispatch: function(e) {
                var t, n, i, o, r, s, a = fe.event.fix(e),
                ...
                if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                    for (s = fe.event.handlers.call(this, a, u), t = 0;
                        ...
                        for (a.currentTarget = o.elem, n = 0;
                            (r = o.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (i = ((fe.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
                ...
                if (l && u.nodeType && !("click" === e.type && e.button >= 1))
                    for (; u !== this; u = u.parentNode || this)
                        if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                            for (r = [], s = {}, n = 0; n < l; n++) i = t[n], o = i.selector + " ", void 0 === s[o] && (s[o] = i.needsContext ? fe(o, this).index(u) > -1 : fe.find(o, this, null, [u]).length), s[o] && r.push(i);
                            r.length && a.push({
                                elem: u,
                                handlers: r
                            })
        ...
        fe.extend({
            ...
            cleanData: function(e) {
                for (var t, n, i, o = fe.event.special, r = 0; void 0 !== (n = e[r]); r++)
                    if (Me(n)) {
                        if (t = n[$e.expando]) {
                            if (t.events)
                                for (i in t.events) o[i] ? fe.event.remove(n, i) : fe.removeEvent(n, i, t.handle);
                            n[$e.expando] = void 0
                        }
            ...
            html: function(e) {
                return Ee(this, function(e) {
                    ...
                    if ("string" == typeof e && !Ge.test(e) && !qe[(Re.exec(e) || ["", ""])[1].toLowerCase()]) {
                        e = fe.htmlPrefilter(e);
                        try {
                            for (; n < i; n++) t = this[n] || {}, 1 === t.nodeType && (fe.cleanData(y(t, !1)), t.innerHTML = e);
                            t = 0
                        } catch (e) {}
                    }
            ...
            fe.fn[e] = function(e) {
                for (var n, i = [], o = fe(e), r = o.length - 1, s = 0; s <= r; s++) n = s === r ? this : this.clone(!0), fe(o[s])[t](n), se.apply(i, n.get());
        ...
        fe.extend({
            ...
            style: function(e, t, n, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var o, r, s, a = fe.camelCase(t),
                        l = ot.test(t),
                        u = e.style;
                    if (l || (t = N(a)), s = fe.cssHooks[t] || fe.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : u[t];
                    r = typeof n, "string" === r && (o = Pe.exec(n)) && o[1] && (n = m(e, t, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (fe.cssNumber[a] ? "" : "px")), pe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
                }
            },
            css: function(e, t, n, i) {
                var o, r, s, a = fe.camelCase(t);
                return ot.test(t) || (t = N(a)), s = fe.cssHooks[t] || fe.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = A(e, t, i)), "normal" === o && t in st && (o = st[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
            }
        }), fe.each(["height", "width"], function(e, t) {
            fe.cssHooks[t] = {
                get: function(e, n, i) {
                    if (n) return !it.test(fe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? F(e, t, i) : He(e, rt, function() {
                        return F(e, t, i)
                    })
                },
                set: function(e, n, i) {
                    var o, r = i && nt(e),
                        s = i && W(e, t, i, "border-box" === fe.css(e, "boxSizing", !1, r), r);
                    return s && (o = Pe.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = fe.css(e, t)), P(e, n, s)
                }
            }
        }), fe.cssHooks.marginLeft = j(pe.reliableMarginLeft, function(e, t) {
            ...
            }, et.test(e) || (fe.cssHooks[e + t].set = P)
        }), fe.fn.extend({
            css: function(e, t) {
                return Ee(this, function(e, t, n) {
                    var i, o, r = {},
                        s = 0;
                    if (Array.isArray(t)) {
                        for (i = nt(e), o = t.length; s < o; s++) r[t[s]] = fe.css(e, t[s], !1, i);
                        return r
                    }
        ...
        var pt, ft = fe.expr.attrHandle;
        fe.fn.extend({
            attr: function(e, t) {
                return Ee(this, fe.attr, e, t, arguments.length > 1)
            },
            ...
            attr: function(e, t, n) {
                ...
                if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? fe.prop(e, t, n) : (1 === r && fe.isXMLDoc(e) || (o = fe.attrHooks[t.toLowerCase()] || (fe.expr.match.bool.test(t) ? pt : void 0)), void 0 !== n ? null === n ? void fe.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : (i = fe.find.attr(e, t), null == i ? void 0 : i))
            },
            attrHooks: {
                type: {
                    set: function(e, t) {
        ...
        fe.fn.extend({
            prop: function(e, t) {
                return Ee(this, fe.prop, e, t, arguments.length > 1)
            },
            ...
            toggleClass: function(e, t) {
                ...
                return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : fe.isFunction(e) ? this.each(function(n) {
                    ...
                    var t, i, o, r;
                    if ("string" === n)
                        for (i = 0, o = fe(this), r = e.match(Se) || []; t = r[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                    else void 0 !== e && "boolean" !== n || (t = Q(this), t && $e.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : $e.get(this, "__className__") || ""))
                })
            },
            hasClass: function(e) {
                var t, n, i = 0;
            ...
            val: function(e) {
                var t, n, i, o = this[0]; {
                    if (arguments.length) return i = fe.isFunction(e), this.each(function(n) {
                        var o;
                        1 === this.nodeType && (o = i ? e.call(this, n, fe(this).val()) : e, null == o ? o = "" : "number" == typeof o ? o += "" : Array.isArray(o) && (o = fe.map(o, function(e) {
                            return null == e ? "" : e + ""
                        })), (t = fe.valHooks[this.type] || fe.valHooks[this.nodeName.toLowerCase()]) && "set" in t && void 0 !== t.set(this, o, "value") || (this.value = o))
                    });
                    if (o) return (t = fe.valHooks[o.type] || fe.valHooks[o.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(/\r/g, "") : null == n ? "" : n)
                }
            }
        }), fe.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (var n, i, o = e.options, r = fe.makeArray(t), s = o.length; s--;) i = o[s], (i.selected = fe.inArray(fe.valHooks.option.get(i), r) > -1) && (n = !0);
        ...
        fe.extend(fe.event, {
            trigger: function(t, n, i, o) {
                var r, s, a, l, u, c, d, h = [i || ne],
                    p = ce.call(t, "type") ? t.type : t,
                    f = ce.call(t, "namespace") ? t.namespace.split(".") : [];
                if (s = a = i = i || ne, 3 !== i.nodeType && 8 !== i.nodeType && !vt.test(p + fe.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), u = p.indexOf(":") < 0 && "on" + p, t = t[fe.expando] ? t : new fe.Event(p, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : fe.makeArray(n, [t]), d = fe.event.special[p] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                    if (!o && !d.noBubble && !fe.isWindow(i)) {
                        for (l = d.delegateType || p, vt.test(l + p) || (s = s.parentNode); s; s = s.parentNode) h.push(s), a = s;
                        a === (i.ownerDocument || ne) && h.push(a.defaultView || a.parentWindow || e)
                    }
                    for (r = 0;
                        (s = h[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || p, c = ($e.get(s, "events") || {})[t.type] && $e.get(s, "handle"), c && c.apply(s, n), (c = u && s[u]) && c.apply && Me(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
                    return t.type = p, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(h.pop(), n) || !Me(i) || u && fe.isFunction(i[p]) && !fe.isWindow(i) && (a = i[u], a && (i[u] = null), fe.event.triggered = p, i[p](), fe.event.triggered = void 0, a && (i[u] = a)), t.result
                }
            },
        ...
        fe.param = function(e, t) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var e = this.type;
                    return this.name && !fe(this).is(":disabled") && Ct.test(this.nodeName) && !Tt.test(e) && (this.checked || !Le.test(e))
                }).map(function(e, t) {
                    var n = fe(this).val();
        ...
        Mt.href = yt.href, fe.extend({
            ...
            ajax: function(t, n) {
                ...
                if (v.promise(C), f.url = ((t || f.url || yt.href) + "").replace(/^\/\//, yt.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(Se) || [""], null == f.crossDomain) {
                ...
                if (f.data && f.processData && "string" != typeof f.data && (f.data = fe.param(f.data, f.traditional)), X(Dt, f, n, C), c) return C;
                d = fe.event && f.global, d && 0 == fe.active++ && fe.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !St.test(f.type), r = f.url.replace(/#.*$/, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(/%20/g, "+")) : (p = f.url.slice(r.length), f.data && (r += (wt.test(r) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (r = r.replace(/([?&])_=[^&]*/, "$1"), p = (wt.test(r) ? "&" : "?") + "_=" + bt++ + p), f.url = r + p), f.ifModified && (fe.lastModified[r] && C.setRequestHeader("If-Modified-Since", fe.lastModified[r]), fe.etag[r] && C.setRequestHeader("If-None-Match", fe.etag[r])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Et + "; q=0.01" : "") : f.accepts["*"]);
                for (h in f.headers) C.setRequestHeader(h, f.headers[h]);
                if (f.beforeSend && (!1 === f.beforeSend.call(m, C, f) || c)) return C.abort();
                if (T = "abort", y.add(f.complete), C.done(f.success), C.fail(f.error), o = X(Ot, f, n, C)) {
        ...
        var $t = {
            ...
            At = fe.ajaxSettings.xhr();
        pe.cors = !!At && "withCredentials" in At, pe.ajax = At = !!At, fe.ajaxTransport(function(t) {
            var n, i;
        ...
        fe.ajaxSetup({
            ...
            jsonpCallback: function() {
                var e = jt.pop() || fe.expando + "_" + bt++;
                return this[e] = !0, e
            }
        }), fe.ajaxPrefilter("json jsonp", function(t, n, i) {
            var o, r, s, a = !1 !== t.jsonp && (It.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && It.test(t.data) && "data");
            if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = fe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(It, "$1" + o) : !1 !== t.jsonp && (t.url += (wt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
                return s || fe.error(o + " was not called"), s[0]
            }, t.dataTypes[0] = "json", r = e[o], e[o] = function() {
                s = arguments
            }, i.always(function() {
                void 0 === r ? fe(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, jt.push(o)), s && fe.isFunction(r) && r(s[0]), s = r = void 0
            }), "script"
            ...
            var i, o, r;
            return t || (pe.createHTMLDocument ? (t = ne.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = ne.location.href, t.head.appendChild(i)) : t = ne), o = we.exec(e), r = !n && [], o ? [t.createElement(o[1])] : (o = w([e], t, r), r && r.length && fe(r).remove(), fe.merge([], o.childNodes))
        }, fe.fn.load = function(e, t, n) {
            var i, o, r, s = this,
                a = e.indexOf(" ");
            return a > -1 && (i = J(e.slice(a)), e = e.slice(0, a)), fe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && fe.ajax({
                url: e,
                type: o || "GET",
                dataType: "html",
                data: t
            ...
            setOffset: function(e, t, n) {
                var i, o, r, s, a, l, u, c = fe.css(e, "position"),
                    d = fe(e),
                    h = {};
                "static" === c && (e.style.position = "relative"), a = d.offset(), r = fe.css(e, "top"), l = fe.css(e, "left"), u = ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1, u ? (i = d.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), fe.isFunction(t) && (t = t.call(e, n, fe.extend({}, a))), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + o), "using" in t ? t.using.call(e, h) : d.css(h)
            }
        }, fe.fn.extend({
            offset: function(e) {
            ...
            fe.cssHooks[t] = j(pe.pixelPosition, function(e, n) {
                if (n) return n = A(e, t), tt.test(n) ? fe(e).position()[t] + "px" : n
            })
        }), fe.each({
            Height: "height",
            Width: "width"
        ...
        return fe.noConflict = function(t) {
            return e.$ === fe && (e.$ = Pt), t && e.jQuery === fe && (e.jQuery = Nt), fe
        }, t || (e.jQuery = e.$ = fe), fe
    }), function(e, t, n) {
        function i(n) {
            var i = t.console;
        ...
        o(e, "attrFn", s || {}, "jQuery.attrFn is deprecated"), e.attr = function(t, n, o, r) {
            var l = n.toLowerCase(),
                u = t && t.nodeType;
            return r && (a.length < 4 && i("jQuery.fn.attr( props, pass ) is deprecated"), t && !d.test(u) && (s ? n in s : e.isFunction(e.fn[n]))) ? e(t)[n](o) : ("type" === n && void 0 !== o && c.test(t.nodeName) && t.parentNode && i("Can't change the 'type' of an input or button in IE 6/7/8"), !e.attrHooks[l] && h.test(l) && (e.attrHooks[l] = {
                get: function(t, n) {
                    var i, o = e.prop(t, n);
                ...
                set: function(t, n, i) {
                    var o;
                    return !1 === n ? e.removeAttr(t, i) : (o = e.propFix[i] || i, o in t && (t[o] = !0), t.setAttribute(i, i.toLowerCase())), i
                }
            }, p.test(l) && i("jQuery.fn.attr('" + l + "') might use property instead of attribute")), a.call(e, t, n, o))
        }, e.attrHooks.value = {
            get: function(e, t) {
        ...
        e.swap && e.each(["height", "width", "reliableMarginRight"], function(t, n) {
            ...
            var r, s, a = {};
            x || i("jQuery.swap() is undocumented and deprecated");
        ...
        e.fn.data = function(t) {
            var n, o, r = this[0];
            return !r || "events" !== t || 1 !== arguments.length || (n = e.data(r, t), o = e._data(r, t), void 0 !== n && n !== o || void 0 === o) ? T.apply(this, arguments) : (i("Use of jQuery.fn.data('events') is deprecated"), o)
        };
        ...
        e.clean || (e.clean = function(t, n, o, r) {
            ...
            if (e.merge(c, e.buildFragment(t, n).childNodes), o)
                for (l = function(e) {
                    ...
                    }, s = 0; null != (a = c[s]); s++) e.nodeName(a, "script") && l(a) || (o.appendChild(a), void 0 !== a.getElementsByTagName && (u = e.grep(e.merge([], a.getElementsByTagName("script")), l), c.splice.apply(c, [s + 1, 0].concat(u)), s += u.length));
            return c
        });
        var k = e.event.add,
            _ = e.event.remove,
        ...
        e.event.props && "attrChange" !== e.event.props[0] && e.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), e.event.dispatch && o(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), e.event.add = function(e, t, n, o, r) {
            e !== document && A.test(t) && i("AJAX events should be attached to document: " + t), k.call(this, e, I(t || ""), n, o, r)
        }, e.event.remove = function(e, t, n, i, o) {
            _.call(this, e, I(t) || "", n, i, o)
        }, e.each(["load", "unload", "error"], function(t, n) {
            e.fn[n] = function() {
                var e = Array.prototype.slice.call(arguments, 0);
                return "load" === n && "string" == typeof e[0] ? M.apply(this, e) : (i("jQuery.fn." + n + "() is deprecated"), e.splice(0, 0, n), arguments.length ? this.bind.apply(this, e) : (this.triggerHandler.apply(this, e), this))
            }
            ...
            return i("jQuery.fn.live() is deprecated"), O ? O.apply(this, arguments) : (e(this.context).on(t, this.selector, n, o), this)
            ...
            return n || A.test(e) || i("Global events are undocumented and deprecated"), S.call(this, e, t, n || document, o)
        ...
        if (e.fn.andSelf = function() {
                return i("jQuery.fn.andSelf() replaced by jQuery.fn.addBack()"), N.apply(this, arguments)
...
function(e, t, n, i) {
    ...
    o.Defaults = {
        ...
        return this.settings.freeDrag || e.each(r, e.proxy(function(e, s) {
            return "left" === n && t > s - 30 && t < s + 30 ? i = e : "right" === n && t > s - o - 30 && t < s - o + 30 ? i = e + 1 : this.op(t, "<", s) && this.op(t, ">", r[e + 1] || s - o) && (i = "left" === n ? e + 1 : e), -1 === i
        ...
        var n = this.current(),
            ...
            a = this.minimum(),
            l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(o) > s / 2 && (o += -1 * r * s), e = n + o, (i = ((e - a) % s + s) % s + a) !== e && i - o <= l && i - o > 0 && (n = i - o, e = i, this.reset(n))) : this.settings.rewind ? (l += 1, e = (e % l + l) % l) : e = Math.max(a, Math.min(l, e)), this.speed(this.duration(n, e, t)), this.current(e), this.$element.is(":visible") && this.update()
        ...
        this._core = t, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": e.proxy(function(t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                    for (var n = this._core.settings, i = n.center && Math.ceil(n.items / 2) || n.items, o = n.center && -1 * i || 0, r = (t.property && void 0 !== t.property.value ? t.property.value : this._core.current()) + o, s = this._core.clones().length, a = e.proxy(function(e, t) {
                            this.load(t)
                        }, this); o++ < i;) this.load(s / 2 + this._core.relative(r)), s && e.each(this._core.clones(this._core.relative(r)), a), r++
            }, this)
        }, this._core.options = e.extend({}, o.Defaults, this._core.options), this._core.$element.on(this._handlers)
    };
    o.Defaults = {
...
function(e, t, n, i) {
    ...
    o.Defaults = {
        ...
        var i, o, r, s = n.width && n.height ? 'style="width:' + n.width + "px;height:" + n.height + 'px;"' : "",
            ...
            d = function(e) {
                o = '<div class="owl-video-play-icon"></div>', i = c.lazyLoad ? '<div class="owl-video-tn ' + u + '" ' + l + '="' + e + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + e + ')"></div>', t.after(i), t.after(o)
            };
        ...
        "youtube" === n.type ? (r = "//img.youtube.com/vi/" + n.id + "/hqdefault.jpg", d(r)) : "vimeo" === n.type ? e.ajax({
            type: "GET",
...
function(e, t, n, i) {
    var o = function(t) {
        this.core = t, this.core.options = e.extend({}, o.Defaults, this.core.options), this.swapping = !0, this.previous = void 0, this.next = void 0, this.handlers = {
...
function(e, t, n, i) {
    ...
    o.Defaults = {
        ...
        if ("page" !== s.slideBy && (s.slideBy = Math.min(s.slideBy, s.items)), s.dots || "page" == s.slideBy)
            for (this._pages = [], e = i, t = 0, n = 0; e < o; e++) {
                if (t >= a || 0 === t) {
                    if (this._pages.push({
            ...
            return this.each(function() {
                function i(t) {
                    if (u) {
                        ...
                        e(i).closest("." + o.wrapperClass).is(w.parent()) && r(n, !0), t.preventDefault && !b && t.preventDefault(), b || (t.returnValue = !1)
                    }
                }
                ...
                function r(e, t, n) {
                    b = !1;
                    var i = e,
                        r = w.outerHeight() - S.outerHeight();
                    if (t && (i = parseInt(S.css("top")) + e * parseInt(o.wheelStep) / 100 * S.outerHeight(), i = Math.min(Math.max(i, 0), r), i = e > 0 ? Math.ceil(i) : Math.floor(i), S.css({
                            top: i + "px"
                        })), m = parseInt(S.css("top")) / (w.outerHeight() - S.outerHeight()), i = m * (w[0].scrollHeight - w.outerHeight()), n) {
                        i = e;
                        var s = i / w[0].scrollHeight * w.outerHeight();
                        s = Math.min(Math.max(s, 0), r), S.css({
                            top: s + "px"
                        })
                    }
                    w.scrollTop(i), w.trigger("slimscrolling", ~~i), a(), l()
                }

                function s() {
                    f = Math.max(w.outerHeight() / w[0].scrollHeight * w.outerHeight(), y), S.css({
                        height: f + "px"
                    });
                    var e = f == w.outerHeight() ? "none" : "block";
                    S.css({
                        display: e
                    })
                }
                ...
                function a() {
                    if (s(), clearTimeout(h), m == ~~m) {
                        if (b = o.allowPageScroll, g != m) {
                            var e = 0 == ~~m ? "top" : "bottom";
                            w.trigger("slimscroll", e)
                        }
                    } else b = !1;
                    if (g = m, f >= w.outerHeight()) return void(b = !0);
                    S.stop(!0, !0).fadeIn("fast"), o.railVisible && _.stop(!0, !0).fadeIn("fast")
                }

                function l() {
                    o.alwaysVisible || (h = setTimeout(function() {
                        o.disableFadeOut && u || c || d || (S.fadeOut("slow"), _.fadeOut("slow"))
                    }, 1e3))
                }
                var u, c, d, h, p, f, m, g, v = "<div></div>",
                    y = 30,
                    b = !1,
                    w = e(this);
                if (w.parent().hasClass(o.wrapperClass)) {
                    var x = w.scrollTop();
                    if (S = w.siblings("." + o.barClass), _ = w.siblings("." + o.railClass), s(), e.isPlainObject(n)) {
                        ...
                        if ("scrollTo" in n) x = parseInt(o.scrollTo);
                        else if ("scrollBy" in n) x += parseInt(o.scrollBy);
                        else if ("destroy" in n) return S.remove(), _.remove(), void w.unwrap();
                        r(x, !1, !0)
                    }
                } else if (!(e.isPlainObject(n) && "destroy" in n)) {
                    o.height = "auto" == o.height ? w.parent().height() : o.height;
                    var k = e(v).addClass(o.wrapperClass).css({
                        position: "relative",
                        overflow: "hidden",
                        width: o.width,
                        height: o.height
                    ...
                    var _ = e(v).addClass(o.railClass).css({
                            width: o.size,
                            height: "100%",
                            position: "absolute",
                            top: 0,
                    ...
                    _.css(D), S.css(D), w.wrap(k), w.parent().append(S), w.parent().append(_), o.railDraggable && S.bind("mousedown", function(n) {
                            var i = e(document);
                            return d = !0, t = parseFloat(S.css("top")), pageY = n.pageY, i.bind("mousemove.slimscroll", function(e) {
                                currTop = t + e.pageY - pageY, S.css("top", currTop), r(0, S.position().top, !1)
                            ...
                            if (b || e.originalEvent.preventDefault(), e.originalEvent.touches.length) {
                                r((p - e.originalEvent.touches[0].pageY) / o.touchScrollStep, !0), p = e.originalEvent.touches[0].pageY
                            }
                        }), s(), "bottom" === o.start ? (S.css({
                            top: w.outerHeight() - S.outerHeight()
                        }), r(0, !0)) : "top" !== o.start && (r(e(o.start).position().top, null, !0), o.alwaysVisible || S.hide()),
                        function(e) {
...
function(e) {
    ...
    a.prototype = {
        ...
        open: function(n) {
            ...
            h("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (c("MarkupParse", function(e, t, n, i) {
        ...
        updateItemHTML: function() {
            ...
            t.appendContent(s, i), n.preloaded = !0, h("Change", n), o = n.type, t.container.prepend(t.contentContainer), h("AfterChange")
        },
        ...
        updateStatus: function(e, i) {
            if (t.preloader) {
                ...
                h("UpdateStatus", o), e = o.status, i = o.text, t.preloader.html(i), t.preloader.find("a").on("click", function(e) {
        ...
        modules: [],
        open: function(t, n) {
            return f(), t = t ? e.extend(!0, {}, t) : {}, t.isObj = !0, t.index = n || 0, this.instance.open(t)
        },
        close: function() {
    ...
    e.magnificPopup.registerModule("ajax", {
        ...
        proto: {
            initAjax: function() {
                t.types.push("ajax"), w = t.st.ajax.cursor, c("Close.ajax", T), c("BeforeChange.ajax", T)
            },
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, r) {
                        ...
                        h("ParseAjax", s), t.appendContent(e(s.data), "ajax"), n.finished = !0, x(), t._setFocus(), setTimeout(function() {
                                t.wrap.addClass("mfp-ready")
                            }, 16),
                            t.updateStatus("ready"), h("AjaxContentAdded")
                    },
                    error: function() {
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
                ...
                var n = 0,
                    ...
                    o = function(r) {
                        C && clearInterval(C), C = setInterval(function() {
                            ...
                            n > 200 && clearInterval(C), n++, 3 === n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)
                        }, r)
                    };
                o(1)
            },
            getImage: function(n, i) {
                var o = 0,
                    r = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, h("ImageLoadComplete")) : (o++, o < 200 ? setTimeout(r, 100) : s()))
                    },
                    s = function() {
                ...
                }, n), t.resizeImage(), n.hasSize ? (C && clearInterval(C), n.loadError ? (i.addClass("mfp-loading"), t.updateStatus("error", a.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), t.updateStatus("ready")), i) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), t.findImageSize(n)), i)
            }
        }
    });
    var _, S = function() {
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                r += " mfp-gallery", c("Open" + o, function() {
                ...
                }), c("MarkupParse" + o, function(e, i, o, r) {
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina,
                        n = e.ratio;
                    n = isNaN(n) ? n() : n, n > 1 && (c("ImageHasSize.retina", function(e, t) {
                        t.img.css({
...
! function() {
    "use strict";
    var e, t, n, i, o, r, s;
    r = 864e5, s = 3600, e = function(e, t) {
        return "string" == typeof e && "string" == typeof t && e.toLowerCase() === t.toLowerCase()
    }, t = function(e, n, i) {
        var o = e.toString();
        return i = i || "0", o.length < n ? t(i + o, n) : o
    }, n = function(e) {
        var t, i;
        ...
        parseDate: function(t, n) {
            var i, o, r, s, a, l, u, c, d, h, p = this,
                f = !1,
                m = !1,
                g = p.dateSettings,
                v = {
            ...
            for (o = t.replace(p.separators, "\0").split("\0"), r = 0; r < o.length; r++) switch (s = o[r], a = parseInt(s), i[r]) {
                case "y":
                case "Y":
                    if (!a) return null;
                    d = s.length, v.year = 2 === d ? parseInt((a < 70 ? "20" : "19") + s) : a, f = !0;
                    break;
                case "m":
                case "n":
                case "M":
                ...
                case "g":
                case "h":
                    if (u = i.indexOf("a") > -1 ? i.indexOf("a") : i.indexOf("A") > -1 ? i.indexOf("A") : -1, h = o[u], -1 !== u) c = e(h, g.meridiem[0]) ? 0 : e(h, g.meridiem[1]) ? 12 : -1, a >= 1 && a <= 12 && -1 !== c ? v.hour = a % 12 == 0 ? c : a + c : a >= 0 && a <= 23 && (v.hour = a);
                    else {
        ...
        guessDate: function(e, t) {
            ...
            for (o = 0; o < u.length; o++) {
                if (p = 2, s = u[o], a = parseInt(s.substr(0, 2)), isNaN(a)) return null;
                switch (o) {
                    case 0:
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        if (i = h.getFullYear(), n = s.length, p = n < 4 ? n : 4, !(i = parseInt(n < 4 ? i.toString().substr(0, 4 - n) + s : s.substr(0, 4)))) return null;
                        h.setFullYear(i);
                        break;
                    case 3:
                        h.setHours(a);
                ...
                r = s.substr(p), r.length > 0 && u.splice(o + 1, 0, r)
            }
            return h
        },
        parseFormat: function(e, n) {
            ...
            return i = {
                ...
                W: function() {
                    ...
                    return t(1 + Math.round((e - n) / r / 7), 2)
                },
                F: function() {
                ...
                B: function() {
                    var e = n.getUTCHours() * s,
                        ...
                        o = n.getUTCSeconds();
                    return t(Math.floor((e + i + o + s) / 86.4) % 1e3, 3)
                },
                g: function() {
                    return i.G() % 12 || 12
                },
                ...
                c: function() {
                    return "Y-m-d\\TH:i:sP".replace(/\\?(.?)/gi, l)
                },
                r: function() {
                    return "D, d M Y H:i:s O".replace(/\\?(.?)/gi, l)
                },
                U: function() {
        ...
        formatDate: function(e, t) {
            ...
            if (e instanceof Date) {
                for (o = t.length, n = 0; n < o; n++) "S" !== (s = t.charAt(n)) && "\\" !== s && (n > 0 && "\\" === t.charAt(n - 1) ? l += s : (r = a.parseFormat(s, e), n !== o - 1 && a.intParts.test(s) && "S" === t.charAt(n + 1) && (i = parseInt(r) || 0, r += a.dateSettings.ordinal(i)), l += r));
                return l
            }
            return ""
        }
...
function(e) {
    ...
    var n = {
        ...
        s = function() {
            ...
            "function" == typeof DateFormatter && (i = new DateFormatter({
                dateSettings: e.extend({}, r, s)
            }))
        };
    e.datetimepicker = {
        ...
        return this.each(function() {
            var i, o, r, s, a, l = e(this),
                ...
                g = 0,
                v = function() {};
            if ("hide" === n) return void l.find(".xdsoft_scrollbar").hide();
            e(this).hasClass("xdsoft_scroller_box") || (i = l.children().eq(0), o = l[0].clientHeight, r = i[0].offsetHeight, s = e('<div class="xdsoft_scrollbar"></div>'), a = e('<div class="xdsoft_scroller"></div>'), s.append(a), l.addClass("xdsoft_scroller_box").append(s), v = function(e) {
                var t = u(e).y - h + g;
                ...
                o || l.trigger("resize_scroll.xdsoft_scroller", [n]), h = u(i).y, g = parseInt(a.css("margin-top"), 10), f = s[0].offsetHeight, "mousedown" === i.type || "touchstart" === i.type ? (t.ownerDocument && e(t.ownerDocument.body).addClass("xdsoft_noselect"), e([t.ownerDocument.body, t.contentWindow]).on("touchend mouseup.xdsoft_scroller", function n() {
                ...
                }), e(t.ownerDocument.body).on("mousemove.xdsoft_scroller", v)) : (m = !0, i.stopPropagation(), i.preventDefault())
            }).on("touchmove", function(e) {
                m && (e.preventDefault(), v(e))
            }).on("touchend touchcancel", function() {
                m = !1, g = 0
            }), l.on("scroll_element.xdsoft_scroller", function(e, t) {
                o || l.trigger("resize_scroll.xdsoft_scroller", [t, !0]), t = t > 1 ? 1 : t < 0 || isNaN(t) ? 0 : t, a.css("margin-top", c * t), setTimeout(function() {
                    i.css("marginTop", -parseInt((i[0].offsetHeight - o) * t, 10))
                }, 10)
            }).on("resize_scroll.xdsoft_scroller", function(e, t, n) {
                var u, d;
                o = l[0].clientHeight, r = i[0].offsetHeight, u = o / r, d = u * s[0].offsetHeight, u > 1 ? a.hide() : (a.show(), a.css("height", parseInt(d > 10 ? d : 10, 10)), c = s[0].offsetHeight - a[0].offsetHeight, !0 !== n && l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(i.css("marginTop"), 10)) / (r - o)]))
            }), l.on("mousewheel", function(e) {
                var t = Math.abs(parseInt(i.css("marginTop"), 10));
                return t -= 20 * e.deltaY, t < 0 && (t = 0), l.trigger("scroll_element.xdsoft_scroller", [t / (r - o)]), e.stopPropagation(), !1
            }), l.on("touchstart", function(e) {
                d = u(e), p = Math.abs(parseInt(i.css("marginTop"), 10))
            }), l.on("touchmove", function(e) {
                if (d) {
                    e.preventDefault();
                    var t = u(e);
                    l.trigger("scroll_element.xdsoft_scroller", [(p - (t.y - d.y)) / (r - o)])
                }
            }), l.on("touchend touchcancel", function() {
                d = !1, p = 0
            })), l.trigger("resize_scroll.xdsoft_scroller", [n])
        })
    }, e.fn.datetimepicker = function(r, s) {
        var a, l, u = this,
            c = 48,
            d = 57,
            h = 96,
            ...
            E = 89,
            M = !1,
            $ = e.isPlainObject(r) || !r ? e.extend(!0, {}, n, r) : e.extend(!0, {}, n),
            A = 0,
            j = function(e) {
                e.on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function t() {
                    e.is(":disabled") || e.data("xdsoft_datetimepicker") || (clearTimeout(A), A = setTimeout(function() {
        ...
        return a = function(n) {
            function s() {
                var e, t = !1;
                return $.startDate ? t = N.strToDate($.startDate) : (t = $.value || (n && n.val && n.val() ? n.val() : ""), t ? t = N.strToDateTime(t) : $.defaultDate && (t = N.strToDateTime($.defaultDate), $.defaultTime && (e = N.strtotime($.defaultTime), t.setHours(e.getHours()), t.setMinutes(e.getMinutes())))), t && N.isValidDate(t) ? W.data("changed", !0) : t = "", t || 0
            }
                ...
                var i = function(e, t) {
                    ...
                    o = function(e) {
                        try {
                            if (t.ownerDocument.selection && t.ownerDocument.selection.createRange) {
                                return t.ownerDocument.selection.createRange().getBookmark().charCodeAt(2) - 2
                            }
                    ...
                    r = function(e, n) {
                        ...
                        if (e.createTextRange) {
                            ...
                            return i.collapse(!0), i.moveEnd("character", n), i.moveStart("character", n), i.select(), !0
                        }
                        return !!e.setSelectionRange && (e.setSelectionRange(n, n), !0)
                    };
                t.mask && n.off("keydown.xdsoft"), !0 === t.mask && ("undefined" != typeof moment ? t.mask = t.format.replace(/Y{4}/g, "9999").replace(/Y{2}/g, "99").replace(/M{2}/g, "19").replace(/D{2}/g, "39").replace(/H{2}/g, "29").replace(/m{2}/g, "59").replace(/s{2}/g, "59") : t.mask = t.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === e.type(t.mask) && (i(t.mask, n.val()) || (n.val(t.mask.replace(/[0-9]/g, "_")), r(n[0], 0)), n.on("keydown.xdsoft", function(s) {
                    var a, l, u = this.value,
                        $ = s.which;
                    if ($ >= c && $ <= d || $ >= h && $ <= p || $ === y || $ === m) {
                        for (a = o(this), l = $ !== y && $ !== m ? String.fromCharCode(h <= $ && $ <= p ? $ - c : $) : "_", $ !== y && $ !== m || !a || (a -= 1, l = "_");
                            /[^0-9_]/.test(t.mask.substr(a, 1)) && a < t.mask.length && a > 0;) a += $ === y || $ === m ? -1 : 1;
                        if (u = u.substr(0, a) + l + u.substr(a + 1), "" === e.trim(u)) u = t.mask.replace(/[0-9]/g, "_");
                        else if (a === t.mask.length) return s.preventDefault(), !1;
                        for (a += $ === y || $ === m ? 0 : 1;
                            /[^0-9_]/.test(t.mask.substr(a, 1)) && a < t.mask.length && a > 0;) a += $ === y || $ === m ? -1 : 1;
                        i(t.mask, u) ? (this.value = u, r(this, a)) : "" === e.trim(u) ? this.value = t.mask.replace(/[0-9]/g, "_") : n.trigger("error_input.xdsoft")
                    } else if (-1 !== [_, S, D, O, E].indexOf($) && M || -1 !== [v, w, T, b, x, k, f, C, g].indexOf($)) return !0;
                    return s.preventDefault(), !1
                }))
            }
            var l, u, A, j, I, N, P, W = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
                F = e('<div class="xdsoft_copyright"><a target="_blank" href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'),
                H = e('<div class="xdsoft_datepicker active"></div>'),
                z = e('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'),
                ...
                B = R.find(".xdsoft_time_box").eq(0),
                q = e('<div class="xdsoft_time_variant"></div>'),
                U = e('<button type="button" class="xdsoft_save_selected blue-gradient-button">Save Selected</button>'),
                Y = e('<div class="xdsoft_select xdsoft_monthselect"><div></div></div>'),
                J = e('<div class="xdsoft_select xdsoft_yearselect"><div></div></div>'),
                Q = !1,
                V = 0;
            $.id && W.attr("id", $.id), $.style && W.attr("style", $.style), $.weeks && W.addClass("xdsoft_showweeks"), $.rtl && W.addClass("xdsoft_rtl"), W.addClass("xdsoft_" + $.theme), W.addClass($.className), z.find(".xdsoft_month span").after(Y), z.find(".xdsoft_year span").after(J), z.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function(t) {
                var n, i, o = e(this).find(".xdsoft_select").eq(0),
                    r = 0,
                    s = 0,
                    a = o.is(":visible");
                for (z.find(".xdsoft_select").hide(), N.currentTime && (r = N.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), o[a ? "hide" : "show"](), n = o.find("div.xdsoft_option"), i = 0; i < n.length && n.eq(i).data("value") !== r; i += 1) s += n[0].offsetHeight;
                return o.xdsoftScroller($, s / (o.children()[0].offsetHeight - o[0].clientHeight)), t.stopPropagation(), !1
                ...
                N && N.currentTime && N.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")), e(this).parent().parent().hide(), W.trigger("xchange.xdsoft"), $.onChangeMonth && e.isFunction($.onChangeMonth) && $.onChangeMonth.call(W, N.currentTime, W.data("input")), t !== N.currentTime.getFullYear() && e.isFunction($.onChangeYear) && $.onChangeYear.call(W, N.currentTime, W.data("input"))
            }), W.getValue = function() {
                ...
                $ = e.extend(!0, {}, $, o), o.allowTimes && e.isArray(o.allowTimes) && o.allowTimes.length && ($.allowTimes = e.extend(!0, [], o.allowTimes)), o.weekends && e.isArray(o.weekends) && o.weekends.length && ($.weekends = e.extend(!0, [], o.weekends)), o.allowDates && e.isArray(o.allowDates) && o.allowDates.length && ($.allowDates = e.extend(!0, [], o.allowDates)), o.allowDateRe && "[object String]" === Object.prototype.toString.call(o.allowDateRe) && ($.allowDateRe = new RegExp(o.allowDateRe)), o.highlightedDates && e.isArray(o.highlightedDates) && o.highlightedDates.length && (e.each(o.highlightedDates, function(n, o) {
                    var s, a = e.map(o.split(","), e.trim),
                        l = new t(i.parseDate(a[0], $.formatDate), a[1], a[2]),
                        u = i.formatDate(l.date, $.formatDate);
                    void 0 !== r[u] ? (s = r[u].desc) && s.length && l.desc && l.desc.length && (r[u].desc = s + "\n" + l.desc) : r[u] = l
                }), $.highlightedDates = e.extend(!0, [], r)), o.highlightedPeriods && e.isArray(o.highlightedPeriods) && o.highlightedPeriods.length && (r = e.extend(!0, [], $.highlightedDates), e.each(o.highlightedPeriods, function(n, o) {
                    var s, a, l, u, c, d, h;
                    if (e.isArray(o)) s = o[0], a = o[1], l = o[2], h = o[3];
                    else {
                        var p = e.map(o.split(","), e.trim);
                        s = i.parseDate(p[0], $.formatDate), a = i.parseDate(p[1], $.formatDate), l = p[2], h = p[3]
                    }
                    for (; s <= a;) u = new t(s, l, h), c = i.formatDate(s, $.formatDate), s.setDate(s.getDate() + 1), void 0 !== r[c] ? (d = r[c].desc) && d.length && u.desc && u.desc.length && (r[c].desc = d + "\n" + u.desc) : r[c] = u
                }), $.highlightedDates = e.extend(!0, [], r)), o.disabledDates && e.isArray(o.disabledDates) && o.disabledDates.length && ($.disabledDates = e.extend(!0, [], o.disabledDates)), o.disabledWeekDays && e.isArray(o.disabledWeekDays) && o.disabledWeekDays.length && ($.disabledWeekDays = e.extend(!0, [], o.disabledWeekDays)), !$.open && !$.opened || $.inline || n.trigger("open.xdsoft"), $.inline && (Q = !0, W.addClass("xdsoft_inline"), n.after(W).hide()), $.inverseButton && ($.next = "xdsoft_prev", $.prev = "xdsoft_next"), $.datepicker ? H.addClass("active") : H.removeClass("active"), $.timepicker ? R.addClass("active") : R.removeClass("active"), $.value && (N.setCurrentTime($.value), n && n.val && n.val(N.str)), isNaN($.dayOfWeekStart) ? $.dayOfWeekStart = 0 : $.dayOfWeekStart = parseInt($.dayOfWeekStart, 10) % 7, $.timepickerScrollbar || B.xdsoftScroller($, "hide"), $.minDate && /^[\+\-](.*)$/.test($.minDate) && ($.minDate = i.formatDate(N.strToDateTime($.minDate), $.formatDate)), $.maxDate && /^[\+\-](.*)$/.test($.maxDate) && ($.maxDate = i.formatDate(N.strToDateTime($.maxDate), $.formatDate)), U.toggle($.showApplyButton), z.find(".xdsoft_today_button").css("visibility", $.todayButton ? "visible" : "hidden"), z.find("." + $.prev).css("visibility", $.prevButton ? "visible" : "hidden"), z.find("." + $.next).css("visibility", $.nextButton ? "visible" : "hidden"), a($), $.validateOnBlur && n.off("blur.xdsoft").on("blur.xdsoft", function() {
                    if ($.allowBlank && (!e.trim(e(this).val()).length || "string" == typeof $.mask && e.trim(e(this).val()) === $.mask.replace(/[0-9]/g, "_"))) e(this).val(null), W.data("xdsoft_datetime").empty();
                    else {
                        var t = i.parseDate(e(this).val(), $.format);
                        if (t) e(this).val(i.formatDate(t, $.format));
                        else {
                            var n = +[e(this).val()[0], e(this).val()[1]].join(""),
                                o = +[e(this).val()[2], e(this).val()[3]].join("");
                            !$.datepicker && $.timepicker && n >= 0 && n < 24 && o >= 0 && o < 60 ? e(this).val([n, o].map(function(e) {
                                return e > 9 ? e : "0" + e
                            }).join(":")) : e(this).val(i.formatDate(N.now(), $.format))
                        }
                        W.data("xdsoft_datetime").setCurrentTime(e(this).val())
                    }
                    W.trigger("changedatetime.xdsoft"), W.trigger("close.xdsoft")
                }), $.dayOfWeekStartPrev = 0 === $.dayOfWeekStart ? 6 : $.dayOfWeekStart - 1, W.trigger("xchange.xdsoft").trigger("afterOpen.xdsoft")
            }, W.data("options", $).on("touchstart mousedown.xdsoft", function(e) {
                return e.stopPropagation(), e.preventDefault(), J.hide(), Y.hide(), !1
            }), B.append(q), B.xdsoftScroller($), W.on("afterOpen.xdsoft", function() {
                B.xdsoftScroller($)
            }), W.append(H).append(R), !0 !== $.withoutCopyright && W.append(F), H.append(z).append(L).append(U), e($.parentID).append(W), l = function() {
                var t = this;
                t.now = function(e) {
                    var n, i, o = new Date;
                    return !e && $.defaultDate && (n = t.strToDateTime($.defaultDate), o.setDate(1), o.setFullYear(n.getFullYear()), o.setMonth(n.getMonth()), o.setDate(n.getDate())), $.yearOffset && o.setFullYear(o.getFullYear() + $.yearOffset), !e && $.defaultTime && (i = t.strtotime($.defaultTime), o.setHours(i.getHours()), o.setMinutes(i.getMinutes())), o
                }, t.isValidDate = function(e) {
                    return "[object Date]" === Object.prototype.toString.call(e) && !isNaN(e.getTime())
                }, t.setCurrentTime = function(e, n) {
                    "string" == typeof e ? t.currentTime = t.strToDateTime(e) : t.isValidDate(e) ? t.currentTime = e : e || n || !$.allowBlank ? t.currentTime = t.now() : t.currentTime = null, W.trigger("xchange.xdsoft")
                }, t.empty = function() {
                    t.currentTime = null
                    ...
                    return 12 === i && (t.currentTime.setFullYear(t.currentTime.getFullYear() + 1), i = 0), n = t.currentTime.getFullYear(), t.currentTime.setDate(Math.min(new Date(t.currentTime.getFullYear(), i + 1, 0).getDate(), t.currentTime.getDate())), t.currentTime.setMonth(i), $.onChangeMonth && e.isFunction($.onChangeMonth) && $.onChangeMonth.call(W, N.currentTime, W.data("input")), n !== t.currentTime.getFullYear() && e.isFunction($.onChangeYear) && $.onChangeYear.call(W, N.currentTime, W.data("input")), W.trigger("xchange.xdsoft"), i
                }, t.prevMonth = function() {
                    void 0 !== t.currentTime && null !== t.currentTime || (t.currentTime = t.now());
                    var n = t.currentTime.getMonth() - 1;
                    return -1 === n && (t.currentTime.setFullYear(t.currentTime.getFullYear() - 1), n = 11), t.currentTime.setDate(Math.min(new Date(t.currentTime.getFullYear(), n + 1, 0).getDate(), t.currentTime.getDate())), t.currentTime.setMonth(n), $.onChangeMonth && e.isFunction($.onChangeMonth) && $.onChangeMonth.call(W, N.currentTime, W.data("input")), W.trigger("xchange.xdsoft"), n
                }, t.getWeekOfYear = function(t) {
                    if ($.onGetWeekOfYear && e.isFunction($.onGetWeekOfYear)) {
                        var n = $.onGetWeekOfYear.call(W, t);
                    ...
                    var n, o, r = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : (r = /^(\+|\-)(.*)$/.exec(e), r && (r[2] = i.parseDate(r[2], $.formatDate)), r && r[2] ? (n = r[2].getTime() - 6e4 * r[2].getTimezoneOffset(), o = new Date(t.now(!0).getTime() + parseInt(r[1] + "1", 10) * n)) : o = e ? i.parseDate(e, $.format) : t.now(), t.isValidDate(o) || (o = t.now()), o)
                }, t.strToDate = function(e) {
                    if (e && e instanceof Date && t.isValidDate(e)) return e;
                    var n = e ? i.parseDate(e, $.formatDate) : t.now(!0);
                    return t.isValidDate(n) || (n = t.now(!0)), n
                }, t.strtotime = function(e) {
                    if (e && e instanceof Date && t.isValidDate(e)) return e;
                    var n = e ? i.parseDate(e, $.formatTime) : t.now(!0);
                    return t.isValidDate(n) || (n = t.now(!0)), n
                }, t.str = function() {
                    return i.formatDate(t.currentTime, $.format)
                }, t.currentTime = this.now()
            }, N = new l, U.on("touchend click", function(e) {
                e.preventDefault(), W.data("changed", !0), N.setCurrentTime(s()), n.val(N.str()), W.trigger("close.xdsoft")
            }), z.find(".xdsoft_today_button").on("touchend mousedown.xdsoft", function() {
                W.data("changed", !0), N.setCurrentTime(0, !0), W.trigger("afterOpen.xdsoft")
            }).on("dblclick.xdsoft", function() {
                var e, t, i = N.getCurrentTime();
                i = new Date(i.getFullYear(), i.getMonth(), i.getDate()), e = N.strToDate($.minDate), e = new Date(e.getFullYear(), e.getMonth(), e.getDate()), i < e || (t = N.strToDate($.maxDate), t = new Date(t.getFullYear(), t.getMonth(), t.getDate()), i > t || (n.val(N.str()), n.trigger("change"), W.trigger("close.xdsoft")))
            }), z.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function() {
                var t = e(this),
                    n = 0,
                    i = !1;
                ! function e(o) {
                    t.hasClass($.next) ? N.nextMonth() : t.hasClass($.prev) && N.prevMonth(), $.monthChangeSpinner && (i || (n = setTimeout(e, o || 100)))
                }(500), e([$.ownerDocument.body, $.contentWindow]).on("touchend mouseup.xdsoft", function t() {
                    clearTimeout(n), i = !0, e([$.ownerDocument.body, $.contentWindow]).off("touchend mouseup.xdsoft", t)
                })
                ...
                var t, n, i, o, r, s, a, l, u, c, d, h, p;
                if (l = W.data("input"), t = l.offset(), n = l[0], c = "top", i = t.top + n.offsetHeight - 1, o = t.left, r = "absolute", u = e($.contentWindow).width(), h = e($.contentWindow).height(), p = e($.contentWindow).scrollTop(), $.ownerDocument.documentElement.clientWidth - t.left < H.parent().outerWidth(!0)) {
                    var f = H.parent().outerWidth(!0) - n.offsetWidth;
                    o -= f
                }
                "rtl" === l.parent().css("direction") && (o -= W.outerWidth() - l.outerWidth()), $.fixed ? (i -= p, o -= e($.contentWindow).scrollLeft(), r = "fixed") : (a = !1, P(n, function(e) {
                    if ("fixed" === $.contentWindow.getComputedStyle(e).getPropertyValue("position")) return a = !0, !1
                }), a ? (r = "fixed", i + W.outerHeight() > h + p ? (c = "bottom", i = h + p - t.top) : i -= p) : i + n.offsetHeight > h + p && (i = t.top - n.offsetHeight + 1), i < 0 && (i = 0), o + n.offsetWidth > u && (o = u - n.offsetWidth)), s = W[0], P(s, function(e) {
                    if ("relative" === $.contentWindow.getComputedStyle(e).getPropertyValue("position") && u >= e.offsetWidth) return o -= (u - e.offsetWidth) / 2, !1
                }), d = {
                    position: r,
                    left: o,
                    top: "",
                ...
                var n = !0;
                $.onShow && e.isFunction($.onShow) && (n = $.onShow.call(W, N.currentTime, W.data("input"), t)), !1 !== n && (W.show(), I(), e($.contentWindow).off("resize.xdsoft", I).on("resize.xdsoft", I), $.closeOnWithoutClick && e([$.ownerDocument.body, $.contentWindow]).on("touchstart mousedown.xdsoft", function t() {
                    W.trigger("close.xdsoft"), e([$.ownerDocument.body, $.contentWindow]).off("touchstart mousedown.xdsoft", t)
                }))
            }).on("close.xdsoft", function(t) {
                var n = !0;
                z.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), $.onClose && e.isFunction($.onClose) && (n = $.onClose.call(W, N.currentTime, W.data("input"), t)), !1 === n || $.opened || $.inline || W.hide(), t.stopPropagation()
            }).on("toggle.xdsoft", function() {
                W.is(":visible") ? W.trigger("close.xdsoft") : W.trigger("open.xdsoft")
            }).data("input", n), V = 0, W.data("xdsoft_datetime", N), W.setOptions($), N.setCurrentTime(s()), n.data("xdsoft_datetimepicker", W).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function() {
                n.is(":disabled") || n.data("xdsoft_datetimepicker").is(":visible") && $.closeOnInputClick || (clearTimeout(V), V = setTimeout(function() {
                    n.is(":disabled") || (Q = !0, N.setCurrentTime(s(), !0), $.mask && a($), W.trigger("open.xdsoft"))
                }, 100))
            }).on("keydown.xdsoft", function(t) {
                var n, i = t.which;
                return -1 !== [g].indexOf(i) && $.enterLikeTab ? (n = e("input:visible,textarea:visible,button:visible,a:visible"), W.trigger("close.xdsoft"), n.eq(n.index(this) + 1).focus(), !1) : -1 !== [C].indexOf(i) ? (W.trigger("close.xdsoft"), !0) : void 0
            }).on("blur.xdsoft", function() {
                W.trigger("close.xdsoft")
            })
        }, l = function(t) {
            var n = t.data("xdsoft_datetimepicker");
            n && (n.data("xdsoft_datetime", null), n.remove(), t.data("xdsoft_datetimepicker", null).off(".xdsoft"), e($.contentWindow).off("resize.xdsoft"), e([$.contentWindow, $.ownerDocument.body]).off("mousedown.xdsoft touchstart"), t.unmousewheel && t.unmousewheel())
        }, e($.ownerDocument).off("keydown.xdsoftctrl keyup.xdsoftctrl").on("keydown.xdsoftctrl", function(e) {
            e.keyCode === f && (M = !0)
            ...
            if (n) {
                if ("string" === e.type(r)) switch (r) {
                    ...
                    case "destroy":
                        ...
                        break;
                    case "reset":
                        this.value = this.defaultValue, this.value && n.data("xdsoft_datetime").isValidDate(i.parseDate(this.value, $.format)) || n.data("changed", !1), n.data("xdsoft_datetime").setCurrentTime(this.value);
                        break;
                    case "validate":
                        t = n.data("input"), t.trigger("blur.xdsoft");
                        break;
                    default:
                        n[r] && e.isFunction(n[r]) && (u = n[r](s))
                } else n.setOptions(r);
                return 0
            }
            "string" !== e.type(r) && (!$.lazyInit || $.open || $.inline ? a(e(this)) : j(e(this)))
        }), u
...
function(e) {
    ...
    function t(t) {
        ...
        if (t = e.event.fix(s), t.type = "mousewheel", "detail" in s && (h = -1 * s.detail), "wheelDelta" in s && (h = s.wheelDelta), "wheelDeltaY" in s && (h = s.wheelDeltaY), "wheelDeltaX" in s && (d = -1 * s.wheelDeltaX), "axis" in s && s.axis === s.HORIZONTAL_AXIS && (d = -1 * h, h = 0), u = 0 === h ? d : h, "deltaY" in s && (h = -1 * s.deltaY, u = h), "deltaX" in s && (d = s.deltaX, 0 === h && (u = -1 * d)), 0 !== h || 0 !== d) {
            ...
            if (p = Math.max(Math.abs(h), Math.abs(d)), (!r || p < r) && (r = p, i(s, p) && (r /= 40)), i(s, p) && (u /= 40, d /= 40, h /= 40), u = Math[u >= 1 ? "floor" : "ceil"](u / r), d = Math[d >= 1 ? "floor" : "ceil"](d / r), h = Math[h >= 1 ? "floor" : "ceil"](h / r), c.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                f = t.clientX - y.left, m = t.clientY - y.top
            }
            return t.deltaX = d, t.deltaY = h, t.deltaFactor = r, t.offsetX = f, t.offsetY = m, t.deltaMode = 0, a.unshift(t, u, d, h), o && clearTimeout(o), o = setTimeout(n, 200), (e.event.dispatch || e.event.handle).apply(this, a)
        }
    }
...
function(e) {
    ...
    var i = {
            init: function(t) {
                var o = e.extend({}, n, t || {});
                return t.hasOwnProperty("dubleNumbers") && (o.doubleNumbers = t.dubleNumbers), this.each(function() {
                    e(this).data("syotimer-options", o), i._render.apply(this, []), i._perSecondHandler.apply(this, [])
                })
            },
            _render: function() {
                var t, n = e(this),
                    i = n.data("syotimer-options"),
                    r = i.dayVisible ? o.getCellDom("day", "0") : "";
                t = '<div class="timer-head-block">' + i.headTitle + '</div><div class="timer-body-block">' + r + o.getCellDom("hour") + o.getCellDom("minute") + o.getCellDom("second") + '</div><div class="timer-foot-block">' + i.footTitle + "</div>", n.addClass("syotimer").addClass("timer").html(t);
                var s = e(".timer-head-block", n),
                    a = e(".timer-body-block", n),
                    l = e(".timer-foot-block", n),
                    u = {
                        headBlock: s,
                        bodyBlock: a,
                        footBlock: l
                    };
                n.data("syotimer-blocks", u)
            },
            _perSecondHandler: function() {
                ...
                var r = new Date,
                    s = new Date(n.year, n.month - 1, n.day, n.hour, n.minute, n.second),
                    a = o.getDifferenceWithTimezone(r, s, n),
                    l = o.getSecondsToDeadLine(a, n);
                l >= 0 ? (i._refreshUnitsDom.apply(this, [l]), i._applyEffectSwitch.apply(this, [n.effectType])) : (t = e.extend(t, t.data("syotimer-blocks")), n.afterDeadline(t))
            },
            _refreshUnitsDom: function(n) {
                var i = e(this),
                    r = i.data("syotimer-options"),
                    s = ["day", "hour", "minute", "second"],
                    a = o.getUnitsToDeadLine(n),
                    l = t[r.lang];
                r.dayVisible || (a.hour += 24 * a.day, s.splice(0, 1));
                for (var u = 0; u < s.length; u++) {
                    var c = s[u],
                        d = "." + c;
                    e(d + " .tab-val", i).html(o.format2(a[c], "day" != c && r.doubleNumbers)), e(d + " .tab-unit", i).html(o.definitionOfNumerals(a[c], l[c], r.lang))
                }
            },
        ...
        o = {
            ...
            getSecondsToDeadLine: function(e, t) {
                var n, i = e / 1e3;
                if (i = Math.floor(i), t.periodic) {
                    var r, s, a = o.getPeriodUnit(t.periodUnit),
                        l = e / (1e3 * a);
                    l = Math.ceil(l), l = Math.abs(l), i >= 0 ? (s = l % t.periodInterval, s = 0 == s ? t.periodInterval : s, s -= 1) : s = t.periodInterval - l % t.periodInterval, r = i % a, 0 == r && i < 0 && s--, n = Math.abs(s * a + r)
                } else n = i;
                return n
            },
            getUnitsToDeadLine: function(e) {
                for (var t = ["day", "hour", "minute", "second"], n = {}, i = 0; i < t.length; i++) {
                    var r = t[i],
                        s = o.getPeriodUnit(r);
                    n[r] = Math.floor(e / s), e %= s
                }
                return n
            },
            ...
            getDifferenceWithTimezone: function(e, t, n) {
                var i, r = t.getTime() - e.getTime(),
                    s = 0,
                    a = 0;
                if ("local" !== n.timeZone) {
                    s = 1e3 * (parseFloat(n.timeZone) * o.getPeriodUnit("hour") - -e.getTimezoneOffset() * o.getPeriodUnit("minute"))
                }
                if (n.ignoreTransferTime) {
                    a = 1e3 * (-e.getTimezoneOffset() * o.getPeriodUnit("minute") - -t.getTimezoneOffset() * o.getPeriodUnit("minute"))
                }
                return i = s + a, r - i
            },
            ...
            definitionOfNumerals: function(e, t, n) {
                switch (n) {
                    case "rus":
                        var i, o = [2, 0, 1, 1, 1, 2];
                        return i = e % 100 > 4 && e % 100 < 20 ? 2 : o[e % 10 < 15 ? e % 10 : 15], t[i];
                    case "eng":
                        return t[1 == e ? 0 : 1]
                }
            }
        ...
        r = {
            setOption: function(t, n) {
                ...
                o.hasOwnProperty(t) && (o[t] = n, i.data("syotimer-options", o))
            }
        };
    e.fn.syotimer = function(t) {
        ...
        return null === t || "object" == typeof t ? i.init.apply(this, [t]) : void e.error("SyoTimer. Error in call methods: methods is not exist")
    }
}(jQuery);